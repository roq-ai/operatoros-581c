...
import { getHrisIntegrations, deleteHrisIntegrationById } from 'apiSdk/hris-integrations';
...
function HrisIntegrationListPage() {
  ...
  const handleView = (id: string) => {
    if (hasAccess('hris_integration', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)) {
      router.push(`/hris-integrations/view/${id}`);
    }
  };
  ...
  return (
    <AppLayout>
      <Box bg="white" p={4} rounded="md" shadow="md">
        {hasAccess('hris_integration', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
          <Flex justifyContent="space-between" mb={4}>
            <Text as="h1" fontSize="2xl" fontWeight="bold">
              Hris Integration
            </Text>
            <NextLink href={`/hris-integrations/create`} passHref legacyBehavior>
                  ...
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    <Td>
                      {hasAccess('hris_integration', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                        <NextLink href={`/hris-integrations/edit/${record.id}`} passHref legacyBehavior>
                          <Button
