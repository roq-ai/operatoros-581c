...
import { getHrisIntegrationById } from 'apiSdk/hris-integrations';
...
function HrisIntegrationViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Hris Integration Detail View
          </Text>
          {hasAccess('hris_integration', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/hris-integrations/edit/${data?.id}`} passHref legacyBehavior>
              <Button
